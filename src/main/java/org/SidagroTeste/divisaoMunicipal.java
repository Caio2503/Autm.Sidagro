...
public class divisaoMunicipal {
    ...
    public static void preencherDivisaoMunicipal(WebDriverWait wait, boolean distrito, WebDriver driver) {
        ...
        String nomeDivisao = "Teste46"; // variavel usada para guardar o nome do "campo divisao", visto que ele sera usado mais de uma vez
    ...
    public static void campoEdicao(WebDriverWait wait, WebDriver driver){
